...
(function() {
  ...
  if (should_try_flash && can_use_flash()) {
    JpegCameraFlash = (function(_super) {
      ...
      JpegCameraFlash.prototype.engine_name = "flash";
      ...
      JpegCameraFlash.prototype._engine_init = function() {
        ...
        flashvars = {
          ...
          width: this.view_width,
          height: this.view_height,
          hres: this.options.resolution[0],
          vres: this.options.resolution[1],
      ...
      JpegCameraFlash.prototype._engine_viewport_resize = function(new_width, new_height) {
        this._flash.width = new_width;
        this._flash.height = new_height;
        return this._flash._viewport_resize(new_width, new_height);
      };
